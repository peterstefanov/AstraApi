...
public class SupportPlayerRight : MonoBehaviour {
	...
	void OnCollisionEnter (Collision collision) {
		if (workerOne.shouldMove && collision.gameObject.CompareTag ("Wall") && !workerOne.currentCollider.Equals(GameManager.CARDINAL_DIRECTION_EAST)) {
			workerOne.currentCollider = GameManager.CARDINAL_DIRECTION_EAST;
