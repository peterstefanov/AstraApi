...
public class SupportPlayerRightTwo : MonoBehaviour {
	...
	void OnCollisionEnter (Collision collision) {
		if (workerTwo.shouldMove && collision.gameObject.CompareTag ("Wall") && !workerTwo.currentCollider.Equals(GameManager.CARDINAL_DIRECTION_EAST)) {
			workerTwo.currentCollider = GameManager.CARDINAL_DIRECTION_EAST;
			...
			//Debug.Log ("COLLISION DATA SEND TO ASTRASupportPlayerRight: " + collisionDirectionJson);
